...
from cmc_net import Encoder, Decoder, DeepCMCQuant, SoftQuantize, energy_loss
...
class DeepCMCArithmeticEncoding(DeepCMCQuant):
    ...
    def __init__(self, encoder, decoder, quant, latent_dim, **kwargs):
        """
        Add ArithmeticEncoding to DeepCMC-SoftQuant arch
        ...
        """
        # DeepCMC.__init__(self, encoder, decoder, quant, latent_dim, K_sigma=K_sigma, T_sigma=T_sigma, batch_size=batch_size, device=device, hard_sigma=hard_sigma)
        DeepCMCQuant.__init__(self, encoder, decoder, quant, latent_dim, **kwargs)
